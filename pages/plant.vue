<template>
        ...
        <v-list
          ...
          <v-list-item-group>
            <v-list-item v-if="item.watering.amount !== empty">
              ...
              <v-list-item-content>
                {{ item.watering.amount }}x pro {{ item.watering.interval }} gießen
              </v-list-item-content>
            </v-list-item>
            <v-list-item v-if="item.fertilize !== 0">
              ...
              <v-list-item-content>
                Alle {{item.fertilize}} Wochen düngen
              </v-list-item-content>
            </v-list-item>
            ...
            <v-list-item v-else>
              ...
              <v-list-item-content>
                Erinnerungen ans Gießen & Düngen
              </v-list-item-content>
            </v-list-item>
          </v-list-item-group>
        </v-list>
          ...
          <v-expansion-panels
            ...
            <v-expansion-panel
              ...
              <v-expansion-panel-header>
                  ...
                  <v-list-item>
                    <v-list-item-icon>
                      <font-awesome-icon :icon="['fal', 'ruler-vertical']" height="16px" color="$dgreen" />
                    </v-list-item-icon>
                    <v-list-item-content
                    class="growthtitle">
                      {{ item.growth[0].height }} groß
                    </v-list-item-content>
                  </v-list-item>
  ...
  <v-row v-else-if="editPlant">
    <v-col cols="12" sm="8" md="6">
      ...
      ></v-text-field>
      <v-text-field
        v-model="newItem.scientificName"
      ...
      <v-row>
        <v-col
          cols="6">
          <v-text-field
            v-model="newItem.watering.amount"
            type="number"
            label="Häufigkeit"
            outlined
            suffix="Mal"
        ...
        cols="6">    
          <v-select
            v-model="newItem.watering.interval"
            :items="interval"
            label="Zeitraum"
            outlined
            prefix="pro "
      ...
      <p class="subtitle">
        Möchtest du an die Pflege erinnert werden?
      </p>
      <v-checkbox
        v-model="newItem.watrem"
        label="Gießen"
        ></v-checkbox>
      <v-checkbox
        v-model="newItem.ferrem"
        label="Düngen"
        class="fertcheck"
        ></v-checkbox>
